...
{
    public partial class Add_DepartureFlight : Form
    {
        ...
        private void button_Add_Click(object sender, EventArgs e)
        {
            ...
            {
                string sqlQuery = $"insert DepartureFlight Values ('{textBox_FlightNumber.Text}',{comboBox_AirPorts.SelectedValue},'{dateTimePicker_DepartureTime.Value.ToString()}')";
